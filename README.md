...
make bundle VERSION=0.1.0-alpha5 \
  IMG=ghcr.io/neteye-platform/neteye-operator:0.1.0-alpha5 \
  PACKAGE_NAME=neteye-operator
make bundle-build BUNDLE_IMG=ghcr.io/neteye-platform/neteye-operator-bundle:0.1.0-alpha5
```
