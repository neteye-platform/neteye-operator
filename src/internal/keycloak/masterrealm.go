...
// KeycloakRealmEvents and KeycloakRealmBruteForceProtection), so there is
// nothing to set here. Theme is set explicitly because it is optional and
// opt-in on KeycloakRealmSpec — unlike Events and BruteForceProtection,
// "neteye" is NetEye's own branding, not a Keycloak-side default the CRD
